...
// TOKEN DO BOT
define ('TOKEN_BOT', '5376404234:AAGhgB4BUVBuOHkSGv6338ZzgvtLx7cjjmI');

// API KEY https://sms-activate.ru/en/api2
define ('KEY_SMS', '4f2d296e06533869c9d8d19ee0f57762');

// token do mercado pago
define ('ACCESS_TOKEN_MERCADO_PAGO', 'APP_USR-1508737939272668-010923-7a68143f101e710830b2da8a9a22c80b-299089314');
...
define ('ADMS', [521584182, 2088860781]);

define ('CHAT_ID_NOTIFICACAO', '-1001627703877'); // onde irá as notificações de resgate de saldos (opcional)

define ('GRUPO_ID','-1001627703877'); // grupo de bot
//define ('GRUPO_ID','-id bot'); // grupo de bot
...
define ('BONUS_ADICAO', 0.20); // Bonus por adicionar usuario no nosso grupo, em reais
define ('MINIMO_ADICAO', 10); // Minimo de usuarios adicionados para ganhar bonus
